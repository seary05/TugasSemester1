...
def hitung_konversi_suhu(temperatur, tipe_awal, tipe_akhir):
    ...
    if tipe_suhu_awal == "Celcius" and tipe_suhu_akhir == "Reamur":
        ...
        return (suhu * 9/5) + 32
    elif tipe_suhu_awal == "Celcius" and tipe_suhu_akhir == "Kelvin":
        return suhu + 273.15

    elif tipe_suhu_awal == "Fahrenheit" and tipe_suhu_akhir == "Celcius":
        return (suhu-32) * 5/9
    elif tipe_suhu_awal == "Fahrenheit" and tipe_suhu_akhir == "Reamur":
        return (suhu-32) * 4/9
    elif tipe_suhu_awal == "Fahrenheit" and tipe_suhu_akhir == "Kelvin":
        return (suhu + 459.67) * 5/9

    elif tipe_suhu_awal == "Kelvin" and tipe_suhu_akhir == "Celcius":
        return suhu - 273.15
    elif tipe_suhu_awal == "Kelvin" and tipe_suhu_akhir == "Reamur":
        return (suhu - 273.15) * 4/5
    elif tipe_suhu_awal == "Kelvin" and tipe_suhu_akhir == "Fahrenheit":
        return suhu * 9/5 - 459.67 
    
    elif tipe_suhu_awal == "Reamur" and tipe_suhu_akhir == "Celcius":
        return suhu * 5/4
    elif tipe_suhu_awal == "Reamur" and tipe_suhu_akhir == "Fahrenheit":
        return (suhu * 9/4) + 32
    elif tipe_suhu_awal == "Reamur" and tipe_suhu_akhir == "Kelvin":
